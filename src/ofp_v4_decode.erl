...
%%     Config = ofp_utils:binary_to_flags(port_config, ConfigBin),
%%     State = ofp_utils:binary_to_flags(port_state, StateBin),
%%     Curr = ofp_utils:binary_to_flags(port_feature, CurrBin),
%%     Advertised = ofp_utils:binary_to_flags(port_feature, AdvertisedBin),
%%     Supported = ofp_utils:binary_to_flags(port_feature, SupportedBin),
%%     Peer = ofp_utils:binary_to_flags(port_feature, PeerBin),
...
%%     Name = ofp_utils:strip_string(NameBin),
%%     Match = ofp_utils:binary_to_flags(oxm_ofb_match_fields, MatchBin),
%%     Wildcards = ofp_utils:binary_to_flags(oxm_ofb_match_fields, WildcardsBin),
%%     WriteActions = ofp_utils:binary_to_flags(action_type, WriteActionsBin),
%%     ApplyActions = ofp_utils:binary_to_flags(action_type, ApplyActionsBin),
%%     WriteSet = ofp_utils:binary_to_flags(oxm_ofb_match_fields, WriteSetBin),
%%     ApplySet = ofp_utils:binary_to_flags(oxm_ofb_match_fields, ApplySetBin),
%%     Instructions = ofp_utils:binary_to_flags(instruction_type, InstructionsBin),
...
%%     Capabilities = ofp_utils:binary_to_flags(capabilities, CapaBin),
...
%%     Flags = ofp_utils:binary_to_flags(configuration, FlagsBin),
...
%%     Flags = ofp_utils:binary_to_flags(stats_request_flags, FlagsBin),
%%     case Type of
%%         desc ->
...
%%       Data/bytes>> = Binary,
%%     Type = ofp_v3_enum:to_atom(stats_type, TypeInt),
%%     Flags = ofp_utils:binary_to_flags(stats_reply_flag, FlagsBin),
%%     case Type of
%%         desc ->
...
%%             Types = ofp_utils:binary_to_flags(group_type, TypesBin),
%%             Capabilities = ofp_utils:binary_to_flags(group_capabilities, CapabilitiesBin),
%%             Actions1 = ofp_utils:binary_to_flags(action_type, Actions1Bin),
%%             Actions2 = ofp_utils:binary_to_flags(action_type, Actions2Bin),
%%             Actions3 = ofp_utils:binary_to_flags(action_type, Actions3Bin),
%%             Actions4 = ofp_utils:binary_to_flags(action_type, Actions4Bin),
...
%%     Flags = ofp_utils:binary_to_flags(flow_mod_flags, FlagsBin),
%%     <<_:16, MatchLength:16, _/bytes>> = Data,
%%     MatchLengthPad = MatchLength + (8 - (MatchLength rem 8)),
...
%%     Port = get_id(port_no, PortInt),
%%     Config = ofp_utils:binary_to_flags(port_config, ConfigBin),
%%     Mask = ofp_utils:binary_to_flags(port_config, MaskBin),
%%     Advertise = ofp_utils:binary_to_flags(port_feature, AdvertiseBin),
